...
pub struct StuffEnv {
    ...
    pub by_name : HashMap<StringVal,Vec<usize>> //[node_name]=node_element_inds
}
...
pub struct StuffResultEnv {
    ...
    pub by_name : HashMap<StringVal,Vec<Value>> //[node_name]=nodes
}
...
pub struct StuffResult {
    ...
    // pub name_envs : Vec<HashMap<StringVal,Vec<Value>>> //[node_name]=nodes
}
